...
int main(int argc, char **argv){
  ...
  while((c = getopt_long(argc, argv, "b:r:o:d:ih", option_list, NULL)) != -1){
    switch(c){
    case 'b':
      bench = optarg;
...
void usage(){
  printf("Usage for ASSEMBLER MICRO benchmarks:\n\n");
  printf("\t -b, --bench NAME \t name of the benchmark - possible values are basic_op.\n");
